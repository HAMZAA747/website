  ...
  const items = [
    {
      name: 'Oreo Shake',
      price: 399,
      description: 'A thick, creamy blend of crushed Oreo cookies, topped with cookie crumble.',
      image: '/images/shakes/oreo-shake.jpg',
    },
    {
      name: 'Vanilla Shake',
      price: 349,
      description: 'Silky vanilla shake with a smooth finish and vanilla flake topping.',
      image: '/images/shakes/vanilla-shake.jpg',
    },
    {
      name: 'Lotus Premium Shake',
      price: 449,
      description: 'Lotus Biscoff blended shake topped with crushed biscuit for deep flavor.',
